...
make_target() {
  kernel_make -C $(kernel_path) M=$PKG_BUILD/driver/src/devicedrv/mali/ \
    ...
    EXTRA_CFLAGS="-DCONFIG_MALI450 -DCONFIG_MALI_DVFS -DMALI_FAKE_PLATFORM_DEVICE=1 -DCONFIG_MALI_DMA_BUF_MAP_ON_ATTACH" \
    CONFIG_MALI400=m CONFIG_MALI450=y CONFIG_MALI_DVFS=y CONFIG_MALI400_DEBUG=y
}
